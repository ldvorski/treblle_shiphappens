...
func TestRequestRepository_Create(t *testing.T) {
	...
	id := createTestRequest(t, db, "GET", "/anime/1", 200, 1500)
...
func TestRequestRepository_FilterByMethod(t *testing.T) {
	...
	//Create test data
	createTestRequest(t, db, "GET", "/test1", 200, 100)
	createTestRequest(t, db, "POST", "/test2", 200, 200)
	createTestRequest(t, db, "GET", "/test3", 200, 300)
...
func TestRequestRepository_Search(t *testing.T) {
	...
	// Create test data
	createTestRequest(t, db, "GET", "/anime/1", 200, 100)
	createTestRequest(t, db, "GET", "/manga/1", 200, 200)
	createTestRequest(t, db, "GET", "/anime/characters", 200, 300)
